...
::: columns
::: {.column width="50%"}
With a normally equivalent distribution in both the categories, we had the notion that the model will receive sufficient learning tokens
:::
...
::: {.column width="50%"}
![](images/Disaster_word_cloud.png){fig-align="center"}
:::
:::
...
-   Training BERT was computationally expensive, and well as memory intensive. The accuracy score for BERT was 97% on training and 82%
