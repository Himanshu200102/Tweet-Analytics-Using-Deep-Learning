...
-   Write function for Information parsing
...
-   GUI design and build
    ...
    -   It will collect straightforward user inputs, such as precise disaster-related #tags, a specific country, and a defined time range for the events.

    -   The interface will display tweets that can be scrolled through, and it will highlight regions affected by disasters on the map.
...
| Week            | Weekly Task                                                                                                                                       | Members Responsible |
|-----------------|---------------------------------------------------------------------------------------------------------------------------------------------------|---------------------|
| Week 1          | Proposal.                                                                                                                                         | Everyone            |
| Week 2          | Data Exploration and Preprocessing.                                                                                                               | Everyone            |
| Week 3 - Week 4 | Working on setting up the API and Extracting Feature using methods like Tokenization, lemmatization etc. and train Models and perform prediction. | TBD                 |
| Week 5          | Visualize the output by working on developing a GUI.                                                                                              | TBD                 |
| Week 6          | Finalizing the project and complete preparing a presentation.                                                                                     | TBD                 |
