...
| Week 3 - Week 4 | Working on setting up the API and Extracting Featre using methods like Tokenization, lemmatization etc. and train Models and perform prediction. | TBD                 |
